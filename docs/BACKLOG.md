...
- [x] **Wow moment: assemble and run "route IN to OUT" end-to-end**
...
- [x] **Minimal instruction set and single-pass assembler**
...
- [x] **Cycle-accurate stepped CPU with IN/OUT ports**
...
- [x] **Step debugger with live registers and PC highlighting**
...
- [x] **Synthesized WebAudio SFX with mute toggle**
...
- [x] **Responsive layout with keyboard and touch controls**
...
- [x] **Juice pass — tween, impact/goal feedback, reduced motion**
